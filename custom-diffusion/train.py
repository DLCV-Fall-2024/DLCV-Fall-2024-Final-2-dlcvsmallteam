...
class DataModuleFromConfig(pl.LightningDataModule):
    def __init__(self, batch_size, train=None, train2=None, train3=None, validation=None, test=None, predict=None,
        ...
        if train3 is not None and train3['params']['caption'] != '':
            self.dataset_configs["train3"] = train3
    ...
    def _train_dataloader(self):
        ...
        if is_iterable_dataset or self.use_worker_init_fn:
            ...
            init_fn = None
        if "train3" in self.dataset_configs and self.dataset_configs["train3"]['params']["caption"] != '':
            train_set = self.datasets["train"]
            train2_set = self.datasets["train2"]
            train3_set = self.datasets["train3"]
            concat_dataset = ConcatDataset(train_set, train2_set, train3_set)
            return DataLoader(concat_dataset, batch_size=self.batch_size // 2,
                              num_workers=self.num_workers, shuffle=False if is_iterable_dataset else True,
                              worker_init_fn=init_fn)
        elif "train2" in self.dataset_configs and self.dataset_configs["train2"]['params']["caption"] != '':
            train_set = self.datasets["train"]
            train2_set = self.datasets["train2"]
...
if __name__ == "__main__":
    ...
    try:
        ...
        if opt.caption3 != '':
            config.data.params.train3.params.caption = opt.caption3
            config.data.params.train3.params.reg_caption = opt.reg_caption3
            config.data.params.train3.params.datapath = opt.datapath3
            config.data.params.train3.params.reg_datapath = opt.reg_datapath3
